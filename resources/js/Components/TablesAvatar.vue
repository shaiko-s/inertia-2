<template>
    <section class="relative container px-4 mx-auto left-[320px] top-[57px]">
                                        ...
                                        <div class="inline-flex items-center gap-x-3">
                                            ...
                                            <div class="flex items-center gap-x-2">
                                                <img class="object-cover w-10 h-10 rounded-full"
                                                     ...
                                                     alt="">
                                                <div>
                                                    <h2 class="font-medium text-gray-800 dark:text-white ">Arthur Melo
                                                    </h2>
                                        ...
                                        <div class="inline-flex items-center gap-x-3">
                                            ...
                                            <div class="flex items-center gap-x-2">
                                                <img class="object-cover w-10 h-10 rounded-full"
                                                     ...
                                                     alt="">
                                                <div>
                                                    <h2 class="font-medium text-gray-800 dark:text-white ">Amelia.
                                                        Anderson</h2>
                                                    <p class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                        @ameliaanderson</p>
                                                </div>
                                        ...
                                        <div class="inline-flex items-center gap-x-3">
                                            ...
                                            <div class="flex items-center gap-x-2">
                                                <img class="object-cover w-10 h-10 rounded-full"
                                                     ...
                                                     alt="">
                                                <div>
                                                    <h2 class="font-medium text-gray-800 dark:text-white ">junior REIS
                                                    </h2>
                                                    <p class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                        @junior</p>
                                                </div>
                                        ...
                                        <div class="inline-flex items-center gap-x-3">
                                            ...
                                            <div class="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@mia
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
