                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col"
                                    class="w-6/12 px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    Description
                                </th>
                                ...
                                <th scope="col"
                                    class="w-1/12 relative w-1/12 py-3.5 px-4">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            <tr v-for="ingredient in semiproducts">
                                <td class="w-3/12 px-4 py-4 text-sm font-medium whitespace-nowrap">
                                    <div>
                                ...
                                <td class="w-6/12 px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
